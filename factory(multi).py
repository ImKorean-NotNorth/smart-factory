...
from iotdemo import FactoryController, MotionDetector, ColorDetector #모션디텍터 추가
...
def thread_cam2(q):
    # TODO: MotionDetector
    cNotion = MotionDetector()
    cNotion.load_preset('./resources/motion.cfg')

    # TODO: ColorDetector
    cNotion2 = ColorDetector()
    cNotion2.load_preset('./resources/color.cfg')
