...
def main():
    ...
    model_path = sys.argv[1] #어떤모델? 내가 학습시킨 모델? , openvino 모델
    image_path = sys.argv[2] #어떤 이미지? 디텍팅한 이미지? 테스트하려는 이미지?
    device_name = sys.argv[3] # cpu


# model_path = '/home/park/workspace/training_extensions/src/otx/recipe/classification/multi_class_cls/tv_mobilenet_v3_small.yaml'
# image_path = '어디?'
# device_name = 'cpu'
...
# --------------------------- Step 4. Apply preprocessing -------------------------------------------------------------
    ...
    _, 224, 224, _ = input_tensor.shape
